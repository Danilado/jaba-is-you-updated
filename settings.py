...
TEXT_ONLY: Final[Sequence[str]] = ('is', 'and', 'stop', 'push', 'defeat', 'win', 'you', 'move', 'not', 'me', 'ok', 'back', 'best',
             ...
             'dot', 'done', 'defeat', 'cursor', 'cloud', 'cliff', 'chill',  'brick',  'bonus', 'bolt', 'bog', 'anni', 'algae'
             )

OBJECTS: Final[Sequence[str]] = (*TEXT_ONLY, 'cake', 'fire', 'ghost',
           'rock', 'door', 'skull', 'tile', 'bat', 'bird', 'bug', 'rocket', 'fruit', 'love', 'power',
           'rose', 'bat', 'flag', 'hand', 'key', 'sun', 'stump', 'star', 'moon',  'fungi', 'ufo', 'reed', 'cash', 
           'leaf', 'ladder', 'fear', 'door', 'bubble', 'dust', 'cog', 'flower', 'cup', 'fungus', 'box', 'shirt', 'tree',
           ) 
